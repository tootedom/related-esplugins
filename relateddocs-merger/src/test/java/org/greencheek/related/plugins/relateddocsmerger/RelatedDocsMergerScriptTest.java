...
public class RelatedDocsMergerScriptTest {
    ...
    @Before
    public void setup() {
        RelatedDocsMergerFactory factory = new RelatedDocsMergerFactory();
        Map<String,Object> params = new HashMap<String,Object>();
        params.put(RelatedDocsMergerFactory.DEFAULT_COMPARATOR_STRING_KEY,md5);
        ...
        params2.put(RelatedDocsMergerFactory.COMPARATOR_PARAM,CUSTOM_COMPARE_KEY);
    ...
    public void testScriptParametersAddToSourceWhenMD5IsDifferent() throws Exception {
        ...
        source.put(RelatedDocsMergerFactory.DEFAULT_COMPARATOR_STRING_KEY,"xxxx");
        ...
        assertEquals(md5,source.get(RelatedDocsMergerFactory.DEFAULT_COMPARATOR_STRING_KEY));
    }
    ...
    public void testScriptParametersNotAddedToSourceWhenMD5IsSame() throws Exception {
        ...
        Map<String,Object> source = new HashMap<String,Object>();
        source.put(RelatedDocsMergerFactory.DEFAULT_COMPARATOR_STRING_KEY,md5);
        ctx.put("_source",source);
